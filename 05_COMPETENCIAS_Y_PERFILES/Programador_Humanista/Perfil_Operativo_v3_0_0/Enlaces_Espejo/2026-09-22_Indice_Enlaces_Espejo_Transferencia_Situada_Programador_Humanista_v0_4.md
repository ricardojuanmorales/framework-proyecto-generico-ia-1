...
## Programador Humanista v3.0.0 - post integración
...
## 18. Refinamiento post integración

### Método SDD

El PH puede invocar SDD desde la capa metodológica del Framework.

```text
SDD → método invocable
PH → responsabilidad sobre su uso tecnológico situado
```

No se duplica una copia PH del método por defecto.

### Base de Conocimiento federada

El conocimiento común se invoca desde sus fuentes canónicas distribuidas.

Referencia rectora:

`00_CONTROL_MAESTRO/Indices_Maestros/2026-09-22_Indice_Federado_Base_Conocimiento_PH_IT_AT_PreFase2_v0_1.md`

### Regla de transferencia

> Transferir función y razón antes que forma física.

Toda transferencia material debe preservar, proporcionalmente:
...
La deuda de residencia de `Bases_Conocimiento/` PH continúa gobernada por migración progresiva, no por movimiento masivo.

### Estado

Función RELACIÓN robustecida sin aumentar número de carpetas ni crear una arquitectura paralela.

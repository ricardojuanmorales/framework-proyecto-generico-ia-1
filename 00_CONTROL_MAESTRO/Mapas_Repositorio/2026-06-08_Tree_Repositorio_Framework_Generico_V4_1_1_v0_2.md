...
**Código documental:** 2026-06-08_Tree_Repositorio_Framework_Generico_V4_1_1_v0_2
**Fecha:** 2026-06-08
**Versión:** v0.2
**Estado:** Validado para Bloque 0 de Ronda 2A; conserva snapshot `git ls-files` del 2026-06-07 y requiere regeneración posterior tras colocación manual
...
**Documento complementario:** `00_CONTROL_MAESTRO/Tablas_Ubicacion_Documental/2026-06-08_Tabla_Ubicacion_Documental_Framework_Generico_V4_1_1_v0_2.md`
**Documentos relacionados:**
- `00_CONTROL_MAESTRO/TREE_REPOSITORIO_V4_1_1.md`
- `00_CONTROL_MAESTRO/Mapas_Repositorio/Mapa_Completo_Estructura_2026_06_05_v0_2.md`
...
Este documento presenta el **árbol completo y descargable** del repositorio **Framework Genérico V4.1.1** en formato Markdown, generado directamente sobre los archivos versionados en `git` (495 archivos al 2026-06-07) y validado el 2026-06-08 como referencia estructural del Bloque 0 de Ronda 2A.

Sirve como:

```text
1. fotografía estructural de referencia para nuevas sesiones;
...
## 2A. Validación Bloque 0 — Ronda 2A

```text
Estado de validación: aprobado para uso como referencia estructural de Bloque 0.
Alcance: control estructural general del repositorio.
Fecha de validación: 2026-06-08.
Criterio aplicado: no se altera el árbol literal sin una nueva ejecución real de git ls-files.
```

### 2A.1 Decisión de trazabilidad

Este documento **no declara que los archivos nuevos de Ronda 2A ya estén versionados**. Conserva el snapshot real del 2026-06-07 y deja constancia de que, tras la colocación manual de los archivos de Bloque 0 y bloques posteriores, deberá regenerarse una versión futura del Tree.

### 2A.2 Relación con Bloque 0

| Elemento | Estado | Acción |
|---|---|---|
| Tree Repositorio v0.2 | Validado | Usar como referencia estructural de partida |
| Tabla General v0.2 | Validada | Usar para ubicación por cartapacio raíz |
| Protocolo de Pago de Deuda v0.2 | Validado | Usar para ejecutar la cascada por bloques |

### 2A.3 Deuda asociada

| Deuda | Tipo | Prioridad | Estado |
|---|---|---|---|
| Regenerar Tree luego de colocar archivos Ronda 2A | Técnica / trazabilidad | Media-alta | Diferida legítima |
| Actualizar manifest si se modifica estructura física | Control maestro | Media-alta | Diferida hasta colocación manual |
| Verificar sub-cartapacios nuevos con Tabla Fase 2 | Estructural | Alta | Se atenderá en Bloque 1 |
...
```text
1. El árbol incluye únicamente archivos versionados en git (495 archivos al 2026-06-07); no incluye .DS_Store ni archivos ignorados por .gitignore.
2. Los cartapacios marcados solo con README.md están abiertos y a la espera de contenido sustantivo (ver MAPA_COMPLETO_ESTRUCTURA.md para su descripción de uso).
3. El cartapacio 05_COMPETENCIAS_Y_PERFILES/Programador_Humanista/Perfil_Operativo_v3_0_0/ concentra la mayor densidad documental activa (Fase 2 PH-IT-AT).
4. 99_ARCHIVO_HISTORICO conserva copias de cierre y exportaciones; no debe usarse como ubicación primaria de documentos vivos.
```

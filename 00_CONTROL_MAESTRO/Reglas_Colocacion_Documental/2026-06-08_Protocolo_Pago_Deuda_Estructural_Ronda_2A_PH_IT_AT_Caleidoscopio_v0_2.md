# Protocolo de Pago de Deuda Estructural — Ronda 2A PH-IT-AT-Caleidoscopio v0.2

**Código documental:** `2026-06-08_Protocolo_Pago_Deuda_Estructural_Ronda_2A_PH_IT_AT_Caleidoscopio_v0_2`  
**Versión:** v0.2  
**Fecha:** 2026-06-08  
**Estado:** Protocolo rector revisado y validado para aplicación operativa por bloques  
**Fase:** Fase 2  
**Ronda:** Ronda 2A  
...
**Estado de revisión humana:** revisado para aplicación en Bloque 0; requiere integración en Índice Maestro y Enlaces_Espejo  
...
## 0A. Cambios integrados en v0.2

```text
1. Se valida el protocolo como pieza rectora del Bloque 0.
2. Se confirma la cascada de pago de deuda por bloques lógicos.
3. Se incorpora la decisión de trabajar con opción estructural controlada.
4. Se establece que la creación de sub-cartapacios nuevos requiere actualización simultánea de Tabla Fase 2, Índice Maestro y Registro de Organización de Cartapacios.
5. Se confirma que el Tree no debe alterarse manualmente para aparentar archivos aún no versionados.
6. Se confirma que cada bloque debe producir archivos MD descargables e instrucciones de actualización manual.
```

### 0A.1 Bloque 0 validado

| Pieza | Versión | Ruta canónica | Estado |
|---|---|---|---|
| Tree Repositorio | v0.2 | `00_CONTROL_MAESTRO/Mapas_Repositorio/` | Validado como snapshot de partida |
| Tabla General de Ubicación | v0.2 | `00_CONTROL_MAESTRO/Tablas_Ubicacion_Documental/` | Validada como tabla raíz |
| Protocolo de Pago de Deuda | v0.2 | `00_CONTROL_MAESTRO/Reglas_Colocacion_Documental/` | Validado como regla operativa |

### 0A.2 Regla de opción estructural

```text
Se podrán crear sub-cartapacios nuevos solo cuando:
1. exista necesidad funcional clara;
2. la Tabla Fase 2 los registre;
3. el Índice Maestro los referencie;
4. el Registro de Organización de Cartapacios los documente;
5. Enlaces_Espejo registre su modo de invocación cuando aplique;
6. la bitácora y el changelog confirmen el cambio.
```
...
|---|---|---|---|---|
| Registrar protocolo v0.2 en Índice Maestro | Relacional | Alta | Añadir entrada en actualización de índice | Abierta |
| Registrar protocolo v0.2 en Tabla de Ubicación Fase 2 | Ubicación | Alta | Añadir fila con ruta canónica | Abierta |
| Registrar referencia lógica del protocolo v0.2 en Enlaces_Espejo | Invocación | Alta | Añadir a entrada consolidada Ronda 2A | Abierta |
...
| Anotar revisión v0.2 en bitácora | Memoria | Alta | Entrada de bitácora de pago de deuda | Abierta |
| Registrar revisión v0.2 en changelog | Cierre | Media | Entrada de changelog Ronda 2A | Abierta |

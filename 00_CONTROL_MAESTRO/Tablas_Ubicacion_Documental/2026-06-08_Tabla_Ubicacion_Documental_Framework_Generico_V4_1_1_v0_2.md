...
**Código documental:** 2026-06-08_Tabla_Ubicacion_Documental_Framework_Generico_V4_1_1_v0_2
**Fecha:** 2026-06-08
**Versión:** v0.2 (sustituye en alcance general a la v0-1 del 2026-05-28; no sustituye la tabla específica de Fase 2 PH-IT-AT)
**Estado:** Validada para Bloque 0 de Ronda 2A; operativa para actualización manual por bloques
...
**Documento complementario:** `00_CONTROL_MAESTRO/Mapas_Repositorio/2026-06-08_Tree_Repositorio_Framework_Generico_V4_1_1_v0_2.md`
...
**Próxima acción:** usar como tabla general validada para la cascada de actualización; registrar referencia lógica en Índice Maestro y Enlaces_Espejo durante Bloque 1

---

## 1. Propósito

Esta tabla amplía la tabla general del 2026-05-28 (que cubría 6 cartapacios) para reflejar **los 23 cartapacios raíz** que existen hoy en el repositorio (`00_CONTROL_MAESTRO` … `21_WIKI_DOCUMENTACION_HUMANA`, más `99_ARCHIVO_HISTORICO`). Esta versión conserva el alcance v0.2 y queda validada para operar el Bloque 0 de Ronda 2A.
...
| Protocolo de pago de deuda estructural | `00_CONTROL_MAESTRO/Reglas_Colocacion_Documental/` |
...
## 7A. Validación Bloque 0 — Ronda 2A

```text
Estado de validación: validada para uso operativo.
Alcance: tabla general por cartapacio raíz.
Fecha de validación: 2026-06-08.
Relación: complementa la Tabla de Ubicación Documental Fase 2 PH-IT-AT.
```

### 7A.1 Archivos del Bloque 0 y rutas canónicas

| Documento | Versión validada | Ruta canónica | Acción manual |
|---|---|---|---|
| `2026-06-08_Tree_Repositorio_Framework_Generico_V4_1_1_v0_2.md` | v0.2 | `00_CONTROL_MAESTRO/Mapas_Repositorio/` | Colocar como snapshot validado de partida |
| `2026-06-08_Tabla_Ubicacion_Documental_Framework_Generico_V4_1_1_v0_2.md` | v0.2 | `00_CONTROL_MAESTRO/Tablas_Ubicacion_Documental/` | Colocar como tabla general validada |
| `2026-06-08_Protocolo_Pago_Deuda_Estructural_Ronda_2A_PH_IT_AT_Caleidoscopio_v0_2.md` | v0.2 | `00_CONTROL_MAESTRO/Reglas_Colocacion_Documental/` | Colocar como protocolo rector de cascada |

### 7A.2 Decisión estructural

Se acepta la creación controlada de sub-cartapacios cuando la Tabla Fase 2, el Índice Maestro y el Registro de Organización de Cartapacios los documenten explícitamente. Por tanto, los sub-cartapacios futuros de `Bases_Conocimiento/Invocables/` e `Invocables/Formatos/` no se crean desde esta tabla general; se validarán en el Bloque 1 mediante la Tabla Fase 2.

### 7A.3 Deuda saldada y diferida

| Deuda | Estado | Comentario |
|---|---|---|
| Validar tabla general v0.2 | Saldada | Lista para operar como tabla raíz |
| Confirmar ruta del protocolo de pago de deuda | Saldada | `00_CONTROL_MAESTRO/Reglas_Colocacion_Documental/` |
| Registrar referencia en Índice Maestro | Pendiente Bloque 1 | Requiere Índice Maestro editable |
| Registrar enlace espejo funcional | Pendiente Bloque 1 | Requiere actualización de Enlaces_Espejo |


## 8. Pendientes señalados por esta revisión
...
2. Registrar esta tabla general v0.2 como referencia desde el Índice Maestro y Enlaces_Espejo durante Bloque 1.
